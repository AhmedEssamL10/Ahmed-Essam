...
{
    private $id, $name_en, $name_ar, $price, $quantity, $status, $image, $code, $details_ar, $detials_en, $brand_id, $subcategory_id, $created_at, $updated_at;
    ...
    {
        $query = "SELECT id,en_name,price,image,detiles_en FROM products
