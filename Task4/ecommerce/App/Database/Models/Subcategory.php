...
class Subcategory extends Model implements Crud
{
    ...
    {
        $query = "SELECT id, en_name FROM subcatigories WHERE status ="
            . self::ACTIVE . " AND 	catigories_id  = {$this->category_id}";
        return $this->conn->query($query);
    }
    public function getSubcategory()
    {
        $query = "SELECT id FROM subcatigories WHERE id = ? AND status = " . self::ACTIVE;
