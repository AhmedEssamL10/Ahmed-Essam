...
if ($_GET) {
    if (isset($_GET['brand'])) {
        if (is_numeric($_GET['brand'])) { // is number?
            $brand = new Brand;
            $brandsResult = $brand->setId($_GET['brand'])->getBrand();
        ...
        if (is_numeric($_GET['subcategory'])) { // is number?
            $subcategory = new Subcategory;
            $subcategoriesResult = $subcategory->setId($_GET['subcategory'])->getSubcategory();
    ...
    $products = $productObject->read()->fetch_all(MYSQLI_ASSOC);
}
                                    ...
                                    <div class="product-wrapper">
                                        <div class="product-img">
                                            <a href="product-details.php?product=<?= $product['id'] ?>">
                                                <img alt="" src="assets/img/brand-logo/<?= $product['image'] ?>">
                                            </a>
